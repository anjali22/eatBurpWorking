...
export default class RestaurantDetails extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <View style={{ flex: 1, marginTop: -50 }}>
          ...
          <Animated.ScrollView
            ...
            <View style={styles.contentContainerStyle}>
              ...
              <DescriptionCard text={restaurant.description} />
              <InstagramPhotosCard profile={restaurant.instagram} />
              <VisitedCard restaurantId={this.props.restaurant.id} />
            </View>
          </Animated.ScrollView>
        </View>
        ...
        <StatusBar barStyle={getBarStyle(restaurant.color)} />
      </View>
    );
  }
  ...
  _renderNavigationBar() {
    let { color, accentColor } = this.props.restaurant;
  ...
  _handlePressDirections = () => {
    let { address, postalCode, city } = this.props.restaurant;
