...
import updateVisitedRestaurantCacheAsync from './updateVisitedRestaurantCacheAsync';
...
export default [
  ...
  {action: ActionTypes.ADD_VISITED_BREWERY, effect: updateVisitedRestaurantCacheAsync, error: genericErrorHandler},
  {action: ActionTypes.REMOVE_VISITED_BREWERY, effect: updateVisitedRestaurantCacheAsync, error: genericErrorHandler},
